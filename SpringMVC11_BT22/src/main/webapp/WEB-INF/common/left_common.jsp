				...
				<sec:authentication property="principal.member" var="mvo" />
					...
					<sec:authorize access="hasRole('ADMIN')">
						<form action="${cpath}/member/adminPage">
							<button id="adminPage" type="submit" class="form-control btn btn-outline-dark">관리자페이지</button>
						</form>					
						<br>
						<form action="#">
						...
						<form action="${cpath}/learning/learning_list">
							<button id="learning_list" type="submit" class="form-control btn btn-light">강의</button>
						</form><br>
						<form action="${cpath}/board/list">
							<button id="list" type="submit" class="form-control btn btn-light">커뮤니티</button>
						</form>
						<hr>					
						
						<p style="text-align: center">[프론트엔드]</p>
						<form action="#">
							<button type="submit" class="form-control btn btn-light">강의</button>
						</form><br>
						<form action="#">
							<button type="submit" class="form-control btn btn-light">커뮤니티</button>
						</form>
						<hr>
					...
					<form action="${cpath}/member/memberUpdateForm_passwordCheckForm">
						<button id="memberUpdateForm" class="form-control btn btn-outline-dark">계정관리</button>
					</form>
					<br>
