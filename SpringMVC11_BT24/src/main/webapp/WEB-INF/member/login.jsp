				...
				<table style="text-align: center; border: 1px solid #dddddd" class ="table table-borderd">
					...
					<tr>
						<td colspan ="2">
							...
							<input type="submit" class="btn btn-custom btn-sm" value="로그인">												
							<a type="button" class="btn btn-outline-dark btn-sm" href="${cpath}/member/joinForm">회원가입</a>		
							&nbsp;													
							<a type="button" class="btn btn-secondary btn-sm" href="${cpath}/">메인페이지</a>														
						</td>
					</tr>
				</table>
			</form> <!-- 로그인폼 -->
