			...
			<table style="text-align: center; border: 1px solid #dddddd" class ="table table-bordered">
				...
				<tr>
					<td colspan ="3" style="text-align: right">
						<input type="submit" class="btn btn-custom btn  btn-sm" value="회원가입">
						<input type="reset" class="btn btn-outline-dark btn-sm" value="입력취소">												
						<button type="button" class="btn btn-outline-dark btn-sm" onclick="location.href='${cpath}/member/login'">로그인로 페이지이동</button>						
					</td>
				</tr>	
