...
class SpringMvc11ApplicationTests {
	...
	void registerMoreMembers() {
		...
		m2.setUsername("proback82");
		m2.setPassword(passwordEncoder.encode("!2qqqqqq"));
		m2.setRole(Role.STUDENT);
		m2.setCourse("BACK");
		m2.setName("최진영");
		m2.setNick_name("백엔드고수");
		m2.setAge(34);
		m2.setGender("남자");
		m2.setEmail("jypark82@gmail.com");
		m2.setProfile("");
		m2.setEnabled(true);
		...
		m3.setUsername("pixel55");
		m3.setPassword(passwordEncoder.encode("!2qqqqqq"));
		m3.setRole(Role.STUDENT);
		m3.setCourse("BACK"); // 코스는 상황에 맞게 변경해!
		m3.setName("최민지");
		m3.setNick_name("PixelMaster");
		m3.setAge(26);
		m3.setGender("여자");
		m3.setEmail("mjchoi55@gmail.com");
		m3.setProfile("");
		m3.setEnabled(true);
		m3.setUser_code(generateRandomCode(5));
		mapper.join(m3);

		// 4. 윤상민 (fastcode88)
		Member m4 = new Member();
		m4.setUsername("fastcode88");
		m4.setPassword(passwordEncoder.encode("!2qqqqqq"));
		m4.setRole(Role.STUDENT);
		m4.setCourse("BACK");
		m4.setName("윤상민");
		m4.setNick_name("FastCoder");
		m4.setAge(31);
		m4.setGender("남자");
		m4.setEmail("smyoon88@gmail.com");
		m4.setProfile("");
		m4.setEnabled(true);
		m4.setUser_code(generateRandomCode(5));
		mapper.join(m4);

		// 5. 임지호 (skyline10)
		Member m5 = new Member();
		m5.setUsername("skyline10");
		m5.setPassword(passwordEncoder.encode("!2qqqqqq"));
		m5.setRole(Role.STUDENT);
		m5.setCourse("BACK");
		m5.setName("임지호");
		m5.setNick_name("백엔드맨");
		m5.setAge(25);
		m5.setGender("남자");
		m5.setEmail("jhyline10@gmail.com");
		m5.setProfile("");
		m5.setEnabled(true);
