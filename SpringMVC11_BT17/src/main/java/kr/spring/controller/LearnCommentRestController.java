...
import kr.spring.service.LearnCommentService;

@RestController
@RequestMapping("/learnComment/*")
public class LearnCommentRestController {
	
	@Autowired
	private LearnCommentService service;
	...
	@GetMapping("/loadCmt")
    @ResponseBody
    public List<LearnComment> loadCmt(@RequestParam Long idx) {
	...
	public void cmtcmtInsert(LearnComment cmt) { 
		System.out.println("cmtContent값: "+cmt.getCmt_content());
