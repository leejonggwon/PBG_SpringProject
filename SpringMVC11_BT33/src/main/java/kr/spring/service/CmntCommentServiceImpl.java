...
import kr.spring.mapper.CmntCommentMapper;


@Service
public class CmntCommentServiceImpl implements CmntCommentService {
	
	@Autowired
	private CmntCommentMapper mapper;
	...
	//댓글조회
	@Override
	public List<CmntComment> loadCmt(Long idx) {
	...
	public void cmtcmtInsert(CmntComment cmt) {
		...
		//cmt_idx부모댓글
		CmntComment parent = mapper.cmtRead(cmt.getCmt_idx());
