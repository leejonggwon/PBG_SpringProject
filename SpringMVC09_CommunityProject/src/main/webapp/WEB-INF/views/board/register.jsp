	...
	<div class="container">
	  ...
	  <div class="panel panel-default">
		...
		<div class="panel-body">
			<form action="${cpath}/board/register" method="post" enctype="multipart/form-data"> <!-- POST방식: 작성한 글 등록 -->	
			...
			<input type="hidden" name="memID" value="${mvo.memID}">
				...
				<tr>	
					<td>내용</td>
					<td><textarea rows="10" cols="" name="content" class="form-control"></textarea></td>
				</tr>
				<tr>
					<td>파일</td>
