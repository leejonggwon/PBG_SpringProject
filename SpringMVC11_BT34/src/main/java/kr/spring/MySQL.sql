...
DELETE FROM BT_MEMBER WHERE USERNAME = 'admin02';
...
DELETE FROM BT_COMMUNICATION;
DELETE FROM CMNT_COMMENT;
DELETE FROM CMNT_LIKE;


SELECT * FROM BT_MEMBER;

DELETE FROM BT_MEMBER WHERE USERNAME = 'skyline10';


--커뮤니케이션 댓글--
CREATE TABLE CMNT_COMMENT(
	cmt_idx INT AUTO_INCREMENT,         
	idx BIGINT NOT NULL,                  
	cmt_content VARCHAR(2000) NOT NULL, 
	username VARCHAR(20) NOT NULL,       
...
DELETE FROM BT_LEARNING WHERE IDX = 58;
...
DELETE FROM BT_COMMUNICATION WHERE idx BETWEEN 7 AND 8;
...
SELECT * FROM CMNT_LIKE;

DELETE FROM CMNT_LIKE WHERE IDX BETWEEN 7 AND 8;

DELETE FROM BT_COMMUNICATION WHERE IDX = 7 ;

SELECT * FROM BT_BOARD;

DELETE FROM BT_BOARD WHERE IDX = 27 ;

SELECT * FROM BT_BOARD;

DELETE FROM LEARN_COMMENT WHERE CMT_IDX = 15 ;
...
DELETE FROM BT_MEMBER WHERE USERNAME = 'socrates123' ;
