...
<body>
    				...
    				<div class="card-body">
						<form id="regForm">					
    						...
    						<div id="updateDiv" style="display: none;">
    							...
    							<button id="likeBtn" class="btn btn-sm btn-outline-dark" type="button" onclick="likePlus()">♡ 공감</button>						
  ...
  <script type="text/javascript">
	...
	//Like객체생생하기 + like_availavle 값 불러오기
	function insertLike(){
		var idx = $("#regForm #idx").val();	
		...
		$.ajax({
			...
			error: function(){ alert("Like객체생생 + like_availavle 값 불러오기실패"); }
		});
	};
