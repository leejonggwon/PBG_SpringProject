...
public class CommentServiceImpl implements CommentService {
	...
	//댓글조회
	@Override
	public List<Comment> loadCmt(Long idx) {
		return mapper.loadCmt(idx);
	}

	//댓글삭제하기
	@Override
	public void cmtDelete(int cmt_idx) {
		mapper.cmtDelete(cmt_idx);
	}

	//대댓글등록
	@Override
	public void cmtcmtInsert(Comment cmt) {
		
		//cmt_idx부모댓글
		Comment parent = mapper.cmtRead(cmt.getCmt_idx());
