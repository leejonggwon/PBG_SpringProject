...
<body>
	<div class="container">
		...
		<div class="panel panel-default">
			<div>
				<img style="width:100%;" src="${contextPath}/resources/images/main01.png"> <!--views 폴더 아래 있으면 resouces 위치와 똑같다고 보면 된다-->
			</div>
			    ...
			    <div class="tab-content">
				    <div id="home" class="tab-pane fade in active">
				      ...
				      <div style="text-align:center;">
				      	<img style="width:50%;" src="${contextPath}/resources/images/main02.png"> 
				      	<br>
					  </div>
				    ...
				    <div id="menu3" class="tab-pane fade">
				      ...
				      <div style="text-align:center;">
				      	<img style="width:60%;" src="${contextPath}/resources/images/course01.png"> 
					  </div>
					  <br>
					  <ul>
