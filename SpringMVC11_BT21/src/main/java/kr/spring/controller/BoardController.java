...
public class BoardController {
	...
	@PostMapping("/modify") 
	public String modify(Board vo, @RequestParam("uploadFile") MultipartFile file, @RequestParam("uploadFile2") MultipartFile file2, Criteria cri, RedirectAttributes rttr) {
