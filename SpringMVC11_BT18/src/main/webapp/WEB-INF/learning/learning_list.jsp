	    								...
	    								<tr>
	    									...
	    									<td class="table-cnt">
											    <c:choose>
											        ...
											        <c:when test="${vo.role == 'INSTRUCTOR'}">강사</c:when>									       
	    				...
	    				<div class="card-body">
							<form id="regForm">					
	    						...
	    						<div id="uploadFile" class="form-group">
	    							...
	    							<input type="file" id="uploadFile_input" name="uploadFile" class="form-control">
	    						</div>
	...
	function cmtView(data){
		...
		$.each(data, function(index, obj){ //index:순서 표시자
			...
			if(obj.cmt_level == 0 && obj.cmt_available != '1'){
				listHtml += "<button disabled type='button' class='btn btn-custom btn-sm'>대댓</button>";	
				...
				<tr id="cmt_\${obj.cmt_idx}" style="display:none;">
					...
					<form class="cmtcmtForm"> 
						...
						<table id="cmtcmtTbl" class="table table-bordered table-hover">
							<tr>				
								<td>
									<textarea placeholder="대댓글을 입력해주세요." rows="2" cols="" id="cmtcmt_content" name="cmt_content" class="form-control"></textarea>
								</td> 
								<td style="text-align:center; vertical-align:middle; width:80px;"> 
