...
public class CommunicationController {
	...
	@PostMapping("/modify") 
	public String modify(Communication vo, @RequestParam("uploadFile") MultipartFile file, @RequestParam("uploadFile2") MultipartFile file2, Criteria cri, RedirectAttributes rttr) {
	...
	//댓글기능
	@PostMapping("/reply")
	public String reply(Communication vo, @RequestParam("uploadFile") MultipartFile file, Criteria cri, RedirectAttributes rttr) {
