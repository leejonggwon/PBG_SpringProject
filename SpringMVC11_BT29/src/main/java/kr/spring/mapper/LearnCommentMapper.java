...
public interface LearnCommentMapper {
	...
	void cmtInsertSelectKey(LearnComment cmt);
	...
	//대댓글 상세보기 
	LearnComment cmtRead(int cmt_idx);

	//새로운 답글이 들어올 때 기존의 댓글 순서를 +1 하는 기능
	void cmtcmtSeqUpdate(LearnComment parent);
	...
	void cmt_cmt_countUpdate(LearnComment parent);
