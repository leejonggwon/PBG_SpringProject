...
<body>
	...
	<jsp:include page="../common/header.jsp"></jsp:include>
		...
		<div class="panel panel-default">
			...
			<!-- csrf token 값 전달: 이제는 서버로 단순히 회원가입 정보만 전달하는 것이 아니라 서버에서 발행한 토큰도 전달해야 회원가입이 가능하다 -->
				<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
				<!-- name="${_csrf.parameterName}": 내부적으로 존재하는 토큰 _csrf 이름으로 , value="${_csrf.token}": 토큰값을 전달한다  -->
